...
import java.time.LocalDate;
    public class BibliotecaAPP {
        public static void main(String[] args){
            ...
            Emprestimo emprestimo1 = new Emprestimo(membro1, livro1, LocalDate.now(), LocalDate.now().plusWeeks(2));
            System.out.println("Registro do emprestimo 1: ");
            System.out.println(emprestimo1);
            System.out.println("Verificando disponibilidade" + livro1.setDisponivel());
            System.out.println("----------------------------------------------------");

            Emprestimo emprestimo2 = new Emprestimo(membro2, livro2, LocalDate.now(), LocalDate.now().plusWeeks(2));
            System.out.println("Verificando disponibilidade" + livro2.setDisponivel());
            System.out.println("----------------------------------------------------");

            if(livro2.setDisponivel()){
                Emprestimo emprestimo3 = new Emprestimo(membro1, livro2, LocalDate.now(), LocalDate.now().plusWeeks(4));
            }else {
